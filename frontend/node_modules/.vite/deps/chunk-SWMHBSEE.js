...
var RefIcon = React4.forwardRef(CloseOutlined);
if (true) {
...
function MotionProvider(_ref) {
  ...
  return React7.createElement(Context.Provider, {
    value: props
  }, children);
}
...
// node_modules/rc-notification/es/Notice.js
var Notify = React19.forwardRef(function(props, ref) {
  ...
  var _React$useState = React19.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), hovering = _React$useState2[0], setHovering = _React$useState2[1];
  var _React$useState3 = React19.useState(0), _React$useState4 = _slicedToArray(_React$useState3, 2), percent = _React$useState4[0], setPercent = _React$useState4[1];
  var _React$useState5 = React19.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), spentTime = _React$useState6[0], setSpentTime = _React$useState6[1];
  ...
  var closableObj = React19.useMemo(function() {
  ...
  return React19.createElement("div", _extends({}, divProps, {
    ref,
  ...
  }, content), closable && React19.createElement("a", _extends({
    tabIndex: 0,
  ...
  }), closableObj.closeIcon), mergedShowProgress && React19.createElement("progress", {
...
var NotificationContext = import_react9.default.createContext({});
var NotificationProvider = function NotificationProvider2(_ref) {
  var children = _ref.children, classNames6 = _ref.classNames;
  return import_react9.default.createElement(NotificationContext.Provider, {
    value: {
...
var NoticeList = function NoticeList2(props) {
  ...
  var _useContext = (0, import_react10.useContext)(NotificationContext), ctxCls = _useContext.classNames;
  var dictRef = (0, import_react10.useRef)({});
  var _useState = (0, import_react10.useState)(null), _useState2 = _slicedToArray(_useState, 2), latestNotice = _useState2[0], setLatestNotice = _useState2[1];
  var _useState3 = (0, import_react10.useState)([]), _useState4 = _slicedToArray(_useState3, 2), hoverKeys = _useState4[0], setHoverKeys = _useState4[1];
  ...
  return import_react10.default.createElement(CSSMotionList_default, _extends({
    key: placement,
    ...
    }, import_react10.default.createElement(Notice_default, _extends({}, restConfig, {
...
// node_modules/rc-notification/es/Notifications.js
var Notifications = React22.forwardRef(function(props, ref) {
  ...
  var _React$useState = React22.useState([]), _React$useState2 = _slicedToArray(_React$useState, 2), configList = _React$useState2[0], setConfigList = _React$useState2[1];
  ...
  var _React$useState3 = React22.useState({}), _React$useState4 = _slicedToArray(_React$useState3, 2), placements = _React$useState4[0], setPlacements = _React$useState4[1];
  ...
  var emptyRef = React22.useRef(false);
  React22.useEffect(function() {
  ...
  return (0, import_react_dom2.createPortal)(React22.createElement(React22.Fragment, null, placementList.map(function(placement) {
    var placementConfigList = placements[placement];
    var list = React22.createElement(NoticeList_default, {
      key: placement,
...
function useNotification() {
  ...
  var _React$useState = React23.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), container = _React$useState2[0], setContainer = _React$useState2[1];
  var notificationsRef = React23.useRef();
  var contextHolder = React23.createElement(Notifications_default, {
    container,
  ...
  var _React$useState3 = React23.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), taskQueue = _React$useState4[0], setTaskQueue = _React$useState4[1];
  var api = React23.useMemo(function() {
    return {
      open: function open(config) {
...
var WarningContext = React24.createContext({});
var devUseWarning = true ? (component) => {
  const {
    strict
  } = React24.useContext(WarningContext);
...
var StyleContext = React25.createContext({
  hashPriority: "low",
  cache: createCache(),
  defaultCache: true
});
...
var fullClone = _objectSpread2({}, React26);
var useInsertionEffect = fullClone.useInsertionEffect;
var useInsertionEffectPolyfill = function useInsertionEffectPolyfill2(renderEffect, effect, deps) {
  React26.useMemo(renderEffect, deps);
...
var fullClone2 = _objectSpread2({}, React27);
...
function useGlobalCache(prefix2, keyPath, cacheFn, onCacheRemove, onCacheEffect) {
  var _React$useContext = React28.useContext(StyleContext_default), globalCache = _React$useContext.cache;
...
function useStyleRegister(info, styleFn) {
  ...
  var _React$useContext = React29.useContext(StyleContext_default), autoClear = _React$useContext.autoClear, mock = _React$useContext.mock, defaultCache = _React$useContext.defaultCache, hashPriority = _React$useContext.hashPriority, container = _React$useContext.container, ssrInline = _React$useContext.ssrInline, transformers = _React$useContext.transformers, linters = _React$useContext.linters, cache = _React$useContext.cache, enableLayer = _React$useContext.layer;
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      styleNode = React29.createElement(Empty, null);
    } else {
      var _ref6;
      styleNode = React29.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
        dangerouslySetInnerHTML: {
          __html: cachedStyleStr
        }
      }));
    }
    return React29.createElement(React29.Fragment, null, styleNode, node2);
  };
}
...
var LocaleContext = (0, import_react14.createContext)(void 0);
var context_default = LocaleContext;

// node_modules/antd/es/locale/useLocale.js
var React30 = __toESM(require_react());
var useLocale = (componentName, defaultLocale) => {
  const fullLocale = React30.useContext(context_default);
  const getLocale = React30.useMemo(() => {
    var _a;
  ...
  const getLocaleCode = React30.useMemo(() => {
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React31.useMemo(() => Object.assign(Object.assign({}, locale5), {
    exist: true
  }), [locale5]);
  return React31.createElement(context_default.Provider, {
...
var DesignTokenContext = import_react15.default.createContext(defaultConfig);
...
var DisabledContextProvider = (_ref) => {
  ...
  const originDisabled = React34.useContext(DisabledContext);
...
var SizeContextProvider = (_ref) => {
  ...
  const originSize = React35.useContext(SizeContext);
...
// node_modules/antd/es/config-provider/hooks/useConfig.js
function useConfig() {
  const componentDisabled = (0, import_react16.useContext)(DisabledContext_default);
  const componentSize = (0, import_react16.useContext)(SizeContext_default);
  return {
    componentDisabled,
    componentSize
  };
...
function useUniqueMemo(memoFn, deps) {
  return import_react17.default.useMemo(function() {
...
function genStyleUtils(config) {
  ...
  function genCSSVarRegister(component, getDefaultToken, options) {
    ...
    var useCSSVar = function useCSSVar2(rootCls) {
      ...
      return [function(node2) {
        return injectStyle && cssVar ? import_react18.default.createElement(import_react18.default.Fragment, null, import_react18.default.createElement(CSSVarRegister, {
          rootCls,
          cssVar,
          component
        }), node2) : node2;
...
function useToken() {
  const {
    ...
    override,
    cssVar
  } = import_react19.default.useContext(DesignTokenContext);
...
var fullClone3 = Object.assign({}, React39);
var {
  useId
} = fullClone3;
var useEmptyId = () => "";
...
var RefIcon2 = React43.forwardRef(CheckCircleFilled);
if (true) {
...
var RefIcon3 = React44.forwardRef(CloseCircleFilled);
if (true) {
...
var RefIcon4 = React45.forwardRef(ExclamationCircleFilled);
if (true) {
...
var RefIcon5 = React46.forwardRef(InfoCircleFilled);
if (true) {
...
var RefIcon6 = React47.forwardRef(LoadingOutlined);
if (true) {
...
var PureContent = (_ref) => {
  ...
  }, icon || TypeIcon[type], React50.createElement("span", null, children));
};
var PurePanel = (props) => {
  const {
  ...
  const wrapAPI = React51.useMemo(() => {
    ...
    const open = (config) => {
      if (!holderRef.current) {
        true ? warning4(false, "usage", "You are calling notice in render which will break in React 18 concurrent mode. Please trigger in effect instead.") : void 0;
        const fakeResult = () => {
        };
        fakeResult.then = () => {
        };
      ...
      return wrapPromiseFn((resolve) => {
        originOpen(Object.assign(Object.assign({}, restConfig), {
          ...
          placement: "top",
          className: (0, import_classnames6.default)(type && `${noticePrefixCls}-${type}`, className, message === null || message === void 0 ? void 0 : message.className),
...
//# sourceMappingURL=chunk-SWMHBSEE.js.map
